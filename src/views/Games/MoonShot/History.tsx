  ...
  return (
    <div>
      ...
      <Row style={{marginTop:'1.5em'}}>
        <Col span={24}>
          <div style={{borderRadius:'1em', backgroundColor:'var(--game-back-gray)'}}>
            <Tabs defaultActiveKey="1" className="game-moonshot__room__tabs">
              <TabPane tab="Player" key="1" style={{maxHeight:'73vh', overflow:'scroll'}}>
              ...
              <TabPane tab="History" key="2" style={{maxHeight:'73vh', overflow:'scroll'}}>
                <Row style={{padding:'0.5em 1.5em', borderBottom:'1px solid #303030'}}>
                  <Col span={5}>Bust</Col>
                  <Col span={4}>@</Col>
                  <Col span={4}>Bet</Col>
