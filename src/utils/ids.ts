...
export const BET_POOL_STATE_ACCOUNT = new PublicKey("8PTBPAc4yRfe7bumcuE9JSEbbDdfgXoJBMQAQkfnpDPQ");
export const BET_POOL_PDA_ACCOUNT = new PublicKey("PkimpSks8R9KLHsTAupcHyBgYDitaE2PXk697urr3xP");
export const BET_POOL_USDC_ACCOUNT = new PublicKey("Hb6uoWXzasDigsxDyNfUtXqS6fKqm5mwD9QpCwdWKVGs");

// House Pool PubKeys
export const HOUSE_POOL_PROGRAM_ID = new PublicKey("FatTSDYddftPGBVCoV6Uu2aCiMg8B8ZxV3QuoxE2PK6U");
export const HOUSE_POOL_STATE_ACCOUNT = new PublicKey("3Ht6o5wNPFQMr19WddkwLGh6SWNMGfUr8uM9jSojbb86");
export const HOUSE_POOL_PDA_ACCOUNT = new PublicKey("CrCJYSbgSFa6ZE3KviaTSnmGhhBw2t3auYro2N36irH5");
export const HOUSE_POOL_USDC_ACCOUNT = new PublicKey("DfbX9rzzNx1hrGLCTK8sjXZdw88huCQrFdecz3Cm18Xy");

// Game Keys
export const BUST_ACCOUNT = new PublicKey("GkCzD8kfGhPn3L4hXQpwuTjpqbGRQcSKsuqdjTHnHBzT");

//Other Pubkeys
export const HT_MINT = new PublicKey("AzoLurpZR6KJzmcaYoRvYFSY9pkP4JChDTqXcKw7kykc");
