...
export const BET_POOL_STATE_ACCOUNT = new PublicKey("9wijj6b5dHPwx9MLqqYjuzfdVzr3iXfYKUPUfZJAJHX");
export const BET_POOL_PDA_ACCOUNT = new PublicKey("PkimpSks8R9KLHsTAupcHyBgYDitaE2PXk697urr3xP");
export const BET_POOL_USDC_ACCOUNT = new PublicKey("Bdjay452PtM2nkApRaMf7juh723CDC6yXkGw2VUV8JVX");

// House Pool PubKeys
export const HOUSE_POOL_PROGRAM_ID = new PublicKey("FatTSDYddftPGBVCoV6Uu2aCiMg8B8ZxV3QuoxE2PK6U");
export const HOUSE_POOL_STATE_ACCOUNT = new PublicKey("4jAuRuMF8Sz1HVvbwPbnrxKgwsSf9DXTbTYv3vgo9eha");
export const HOUSE_POOL_PDA_ACCOUNT = new PublicKey("CrCJYSbgSFa6ZE3KviaTSnmGhhBw2t3auYro2N36irH5");
export const HOUSE_POOL_USDC_ACCOUNT = new PublicKey("HRKFmjvomtRERskLpHgz74ppkeBVs38bzYTaL3uxGjKC");

//Other Pubkeys
export const HT_MINT = new PublicKey("DDTkPsYRA7mucFCLdSNMjEwTtbAHT9hREzQAUaomuPHq");
