...
export const BET_POOL_STATE_ACCOUNT = new PublicKey("Fnrkq6qCfewVcN29P3DkXdkaQW9mKGtVF3vrcs83EhgX");
export const BET_POOL_PDA_ACCOUNT = new PublicKey("PkimpSks8R9KLHsTAupcHyBgYDitaE2PXk697urr3xP");
export const BET_POOL_USDC_ACCOUNT = new PublicKey("AFW9qKrfAbHEwkAMoxwMX71kPSbd5sGqXcQ9B6eRz7Q3");

// House Pool PubKeys
export const HOUSE_POOL_PROGRAM_ID = new PublicKey("FatTSDYddftPGBVCoV6Uu2aCiMg8B8ZxV3QuoxE2PK6U");
export const HOUSE_POOL_STATE_ACCOUNT = new PublicKey("2cyNLHXprpYGpdcyEuMYFV68mb6GrU7Se7xkEBeyQY1i");
export const HOUSE_POOL_PDA_ACCOUNT = new PublicKey("CrCJYSbgSFa6ZE3KviaTSnmGhhBw2t3auYro2N36irH5");
export const HOUSE_POOL_USDC_ACCOUNT = new PublicKey("CdrUJV65K2MYQLpn2UurR61NLLj4pLuCRbSYnxwHgKXG");

//Other Pubkeys
export const HT_MINT = new PublicKey("Gc2TusD1PRRiRbpwutdqU5ZL5hpu2qnoPJgHFk7FUcjQ");
