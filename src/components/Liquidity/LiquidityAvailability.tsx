    ...
    <div className="liquidity-left">
      <div className="header-align">
        ...
        <div className="liquidity-content">
          ...
          <h3><span className="liquidity-heavy">{tokenAmountToString(htBalance - lockedLiquidity)}</span> USDT</h3>
          <p className="text-primary">{tokenAmountToString(((htBalance - lockedLiquidity) * 100) / (htBalance), 0, 1, 1)}% available</p>
        </div>
        <div className="horizontal-outline" />
        <div className="liquidity-content">
