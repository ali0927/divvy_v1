                    ...
                    {data?.map((market: Market) => {
                        return (
                            <div className="carousel-text">
                                <Row>
                                    <Col span={24}>
                                        <TeamDetails name={market.teamA} logo={"https://storage.googleapis.com/divvy-cdn/" + "MLB/" + market.teamA + ".svg"} />
                                    </Col>
                                    <Col span={24}>
                                        <p className="text-secondary" style={{ marginTop: -4, marginBottom: -5, fontSize: "0.7em", marginLeft: "20%" }}>VS</p>
                                    </Col>
                                    <Col span={24}>
                                        <TeamDetails name={market.teamB} logo={"https://storage.googleapis.com/divvy-cdn/" + "MLB/" + market.teamB + ".svg"} />
                                    </Col>
                                </Row>
                            </div>
                        );
