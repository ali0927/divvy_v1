...
export const MobileHeader = (props: { isMobileMenuVisible: boolean, setMobileMenuVisible: any, isBetSlipsVisible: boolean, setBetSlipsVisible: any, betSlips: Array<BetSlip>, headerType: string }) => {
    return (
        <Row>
